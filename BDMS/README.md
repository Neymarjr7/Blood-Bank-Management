...
3. Download project from github(https://github.com/Neymarjr7/Blood-Bank-Management.git).

   OR follow gitbash commands <br>
     ```t
         i>cd C:\\xampp\htdocs\
        BDMS>git clone https://github.com/Neymarjr7/Blood-Bank-Management.git
...
# Admin Panel
   ...
   <b> Username = </b> jabhanus@syr.edu<br>
   <b>Password = </b> jay123
